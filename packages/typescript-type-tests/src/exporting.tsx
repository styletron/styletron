...
export const Bar = withStyle<
  typeof Foo,
  {
    bar: "bar";
  }
>(Foo, (_props: {bar: "bar"}) => ({color: "red"}));
...
export const Baz = withStyle<
  typeof Bar,
  {
    baz: "baz";
  }
>(Bar, (_props: {baz: "baz"}) => ({color: "red"}));
...
export const Qux = withStyle<
  typeof Baz,
  {
    qux: "qux";
  }
>(Baz, (_props: {qux: "qux"}) => ({color: "red"}));
